...
### Урок 7
Заключительный урок предлагает побаловаться с админкой, меняя настройки по умолчанию на те, что удобны нам. 

![скрин](../lr7/screenshot/screen23.png)

У нас есть страница администрирования вопроса, но вопрос имеет несколько вариантов, а страница администрирования не отображает варианты.

Есть два способа решить эту проблему. Первый - зарегистрировать Choice в админке.

![скрин](../lr7/screenshot/screen24.png)
![скрин](../lr7/screenshot/screen25.png)

Но, на самом деле, это неэффективный способ добавления объектов Choice в систему. Было бы лучше, если бы можно было добавлять кучу вариантов непосредственно при создании объекта Question. Удалим вызов register() для модели Choice. Затем изменим код регистрации вопроса. Однако есть одна небольшая проблема. Для отображения всех полей для ввода связанных объектов Choice требуется много места на экране. По этой причине Django предлагает табличный способ отображения связанных объектов.

![скрин](../lr7/screenshot/screen26.png)

Теперь, когда страница администратора вопросов выглядит хорошо, внесем некоторые изменения в "список изменений" - страницу, на которой отображаются все вопросы в системе.

![скрин](../lr7/screenshot/screen27.png)
![скрин](../lr7/screenshot/screen28.png)
![скрин](../lr7/screenshot/screen29.png)
